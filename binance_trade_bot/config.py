...
class Config:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    def __init__(self):
        ...
        coin_list_filepath = config.get(USER_CFG_SECTION, "coin_list_filepath")
        # Get supported coin list from supported_coin_list file
        if not supported_coin_list and os.path.exists(coin_list_filepath):
            with open(coin_list_filepath) as rfh:
                for line in rfh:
                    line = line.strip()
